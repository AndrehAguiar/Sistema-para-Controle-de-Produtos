...
<div id="geral">
	<div id="topo">
        ...
        <div style="position: absolute; clear: both; float: left; left: 15px; top: 35px; vertical-align: text-top; z-index: 5;">
        <img src="imagens/logo.jpg" width="90" height="90" style="alignment-baseline:central;" />
        
        <span style="width: 309px; text-align: left; font-size: 14px; position: absolute; clear: both; top: 3px; left: 104px; line-height: 130%; height: 97px; z-index: 5;"> <b>Test Programming Language</b><br />
    ...
    <hr style="margin-bottom:-15;"/>
      ...
      <div id="listaCategoria">
         <span id="tablela"><hr/>
         <table width="100%" border="0" align="center" cellpadding="3" cellspacing="3" id="lista_categ">
           <tr>
                          <th>C&oacute;digo</th>
                          <th>Descri&ccedil;&atilde;o</th>
                          <th>Cadastrado</th>
                          <th>ID do Usu&aacute;rio</th>
                       </tr>
                       <?php do { ?>
                         <tr>
                           <td><?php echo $row_RsListaCategoria['id']; ?></td>
                           <td><?php echo $row_RsListaCategoria['descricao']; ?></td>
                           <td><?php echo $row_RsListaCategoria['data_cadastro']; ?></td>
                           <td style="border-right:#333 1px solid;"><?php echo $row_RsListaCategoria['usuario_id']; ?></td>
                       </tr>
                         <?php } while ($row_RsListaCategoria = mysql_fetch_assoc($RsListaCategoria)); ?>
             </table>
       	   </span>
          <?php if ($pageNum_RsListaCategoria > 0) { // Show if not first page ?>
  <a href="<?php printf("%s?pageNum_RsListaCategoria=%d%s", $currentPage, 0, $queryString_RsListaCategoria); ?>"> &lt;&lt; </a>
            
          <a href="<?php printf("%s?pageNum_RsListaCategoria=%d%s", $currentPage, max(0, $pageNum_RsListaCategoria - 1), $queryString_RsListaCategoria); ?>"> &lt; </a>
            <?php } // Show if not first page ?>
&#124; <?php echo ($startRow_RsListaCategoria + 1) ?> a <?php echo min($startRow_RsListaCategoria + $maxRows_RsListaCategoria, $totalRows_RsListaCategoria) ?> &#124;
        <?php if ($pageNum_RsListaCategoria < $totalPages_RsListaCategoria) { // Show if not last page ?>
          <a href="<?php printf("%s?pageNum_RsListaCategoria=%d%s", $currentPage, min($totalPages_RsListaCategoria, $pageNum_RsListaCategoria + 1), $queryString_RsListaCategoria); ?>"> &gt; </a> <a href="<?php printf("%s?pageNum_RsListaCategoria=%d%s", $currentPage, $totalPages_RsListaCategoria, $queryString_RsListaCategoria); ?>"> &gt;&gt; </a>
...
mysql_free_result($RsListaCategoria);
?>
